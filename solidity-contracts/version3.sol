...
contract SPEEDCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SPEEDCoin() {
        ...
        name = "SPEEDCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SPEEDCoin";                                             // Set the symbol for display purposes (CHANGE THIS)
